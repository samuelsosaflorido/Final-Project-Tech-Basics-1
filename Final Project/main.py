...
def show_intro_message(screen, clock):
    ...
    text_surf_1 = font_large.render("Prepare to begin this adventure!", False, (240, 235, 215)) # This is a small welcoming text for the player
    text_surf_2 = font_small.render("We hope you do enjoy it :)", False, (170, 220, 150)) # I tried to make this with pixel art but i don't know looks bit weird if you wanna change it, it's fine
